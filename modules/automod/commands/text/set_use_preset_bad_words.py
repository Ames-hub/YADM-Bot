from modules.automod.commands.views.automod_list_selection import views
...
class command(
    ...
    name="words_menu",
    description="Menu to toggle whether or not we use some of the preset banned words list in this server"
):
