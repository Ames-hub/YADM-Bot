...
1. Set the intensity of the text automod! Use `/automod text intensity` to do that
2. If you have any words you do not want said, add them to the bad word list! use `/automod wordlist add`
